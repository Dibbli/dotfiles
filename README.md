...
| Claude Code + Codex | Shared AI coding memories with platform-specific adapters | [`ai`](ai) · [setup](ai/README.md) |
...
- **AI coding agents**: shared cross-project memories for Claude Code and Codex, plus Claude-specific `/mr` and `/fix` review workflows, provisioned by symlink ([setup](ai/README.md)).
