...
require("lazy").setup({
	...
	-- === Linting & Formatting for Multiple Languages ===
	{
		...
		config = function()
			...
			ft("json"):lint("eslint_d"):fmt("prettierd")
			ft("jsonc"):lint("eslint_d"):fmt("prettierd")
			ft("typescript"):lint("eslint_d"):fmt("prettierd")
			...
			ft("javascriptreact"):lint("eslint_d"):fmt("prettierd")
